    ...
    def generate_tests(self):
        ...
        test_clean = xml_launch(
            ...
            xml_test({'test-name': "cleaning", 'pkg': "atf_core", 'type': "cleaner.py",
                'time-limit': "60", 'args': self.package_name + " " + self.test_generation_config_file})
        )
        ...
        for test in self.tests:
            ...
            test_record.append(xml_node({'unless':'$(arg execute_as_test)', 'pkg':'atf_core', 'type':'sm_test.py', 'name': "atf_recording_" + test.name, 'args':'execute_as_test', 'required': "true", 'output':'screen'}))
