...
class robot_maker():
    def __init__(self):
        self.int_res = [0.35. 0.40, 0.45, 0.5] #[0.25, 0.35, 0.5, 0.6, 0.75, 1.0, 1.5]
        self.part_num = [100, 200, 300, 500] #[25, 50, 75, 100, 150, 200, 500]
        self.mapping = [1]
        self.ndt_match = ["true"]
        self.gain = [2, 3, 5, 8]
        self.dyn_gain = [0.5]
                ...
                for ndt in self.ndt_match:
                    for gain in self.gain:
                        for dyn_gain in self.dyn_gain:
                            ...
                            if(ndt == "true"):
                                filename = str(int(int_res*100))+"mm_"+str(part)+"part"+str(gain)+
                            else:
