...
class CalculateTfLengthRotationParamHandler:
    ...
    def parse_parameter(self, testblock_name, metric_name, params):
        ...
        """
        metric_type = "tf_length_rotation"
        unit = "rad"
        ...
        return CalculateTfLengthRotation(metric_name, testblock_name, params["topics"], params["root_frame"], params["measured_frame"], groundtruth, mode, series_mode, unit)
