    ...
    def parse_parameter(self, testblock_name, params):
        ...
        for metric in params:
            ...
            try:
                ...
                series_mode = None
            metrics.append(CalculateTfLengthTranslation(metric["topics"], metric["root_frame"], metric["measured_frame"], groundtruth_available, groundtruth, groundtruth_epsilon, mode, series_mode))
        return metrics
