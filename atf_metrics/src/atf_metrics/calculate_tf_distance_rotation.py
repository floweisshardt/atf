    ...
    def parse_parameter(self, testblock_name, params):
        ...
        for metric in params:
            ...
            try:
                ...
                series_mode = None
            metrics.append(CalculateTfDistanceRotation(metric["topics"], metric["root_frame"], metric["measured_frame"], groundtruth_available, groundtruth, groundtruth_epsilon, mode, series_mode))
        return metrics
...
class CalculateTfDistanceRotation:
    def __init__(self, topics, root_frame, measured_frame, groundtruth_available, groundtruth, groundtruth_epsilon, mode, series_mode):
        ...
        """
        self.name = 'tf_distance_rotation'
        self.started = False
        self.finished = False
        self.active = False
