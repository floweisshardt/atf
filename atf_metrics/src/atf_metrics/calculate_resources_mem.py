...
class CalculateResourcesMemParamHandler:
    ...
    def parse_parameter(self, testblock_name, params):
        ...
        for metric in params:
            ...
            metrics.append(CalculateResourcesMem(metric, groundtruth, groundtruth_epsilon))
        return metrics
...
class CalculateResourcesMem:
    ...
    def get_result(self):
        ...
        if self.finished:
            ...
            print "resources mem data: ", self.node_data, "\n groundthruth result", groundtruth_result, " \n .................................."
            return "resources_mem", self.node_data, groundtruth_result, self.groundtruth, self.groundtruth_epsilon, details
        else:
            return False
