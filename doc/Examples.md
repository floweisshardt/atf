...
If you have your test app written and configuration setup as shown in the [python example](Examples.md#integrate-the-atf-into-your-own-application), there are new catkin targets which trigger the execution of tests in a package:
